...
export class BiographyComponent implements OnInit, OnDestroy{
    ...
    ngOnInit() {
         ...
         * Correspondences
         */
        this.correspondences_Daniel_I_Bernoulli = new CorrespondenceGroupWithSection(Daniel_I_Bernoulli, [
            new Section('S', [
                new Correspondence(Daniel_I_Bernoulli, Johannes_Scheuchzer)
            ])
        ]);

        this.correspondences_Johann_I_Bernoulli = new CorrespondenceGroupWithSection(Johann_I_Bernoulli,
            [
                new Section('A', [
        ...
        this.correspondences_Johann_II_Bernoulli = new CorrespondenceGroupWithSection(Johann_II_Bernoulli, [
            new Section('M', [
                new Correspondence(Johann_II_Bernoulli, Pierre_Louis_Moreau_de_Maupertuis)]
            )]);

        this.correspondences_Nicolaus_I_Bernoulli = new CorrespondenceGroupWithSection(Nicolaus_I_Bernoulli, [
            new Section('S', [
        ...
        this.correspondences_Nicolaus_II_Bernoulli = new CorrespondenceGroupWithSection(Nicolaus_II_Bernoulli, [
            new Section('S', [
        ...
        this.correspondences_Jacob_Hermann = new CorrespondenceGroupWithSection(Jacob_Hermann, [
            new Section('B', [
        ...
        this.correspondences_Johann_Albrecht_Euler = new CorrespondenceGroup(Johann_Albrecht_Euler, [
