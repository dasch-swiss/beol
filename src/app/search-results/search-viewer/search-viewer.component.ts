...
export class SearchViewerComponent implements OnChanges, OnInit {
            ...
            if (resourceSeq.resources.length === 1) {
              ...
              this._cacheService.getResourceClassDefinitions(resourceClassIris).subscribe(
                (resourceClassInfos: OntologyInformation) => {
                  ...
                  SearchViewerComponent.collectImagesAndRegionsForResource(resourceSeq.resources[0]);
        ...
        promise.then((compacted) => {
          ...
          this._cacheService.getResourceClassDefinitions(resourceClassIris).subscribe(
            (resourceClassInfos: OntologyInformation) => {
              ...
              SearchViewerComponent.collectImagesAndRegionsForResource(this.resource);
